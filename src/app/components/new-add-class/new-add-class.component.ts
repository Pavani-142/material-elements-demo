...
@Component({
  selector: 'app-new-add-class',
  templateUrl: './new-add-class.component.html',
  styleUrls: ['./new-add-class.component.css']
})
export class NewAddClassComponent implements OnInit {
